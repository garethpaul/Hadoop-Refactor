...
CHILD_MARKER = "HADOOP_REFACTOR_MAKE_SPACE_CHILD"
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="hadoop-refactor-make-space-") as temporary:
        ...
        subprocess.run(
            [
                environment.get("HADOOP_REFACTOR_MAKE", "make"),
                "-f",
